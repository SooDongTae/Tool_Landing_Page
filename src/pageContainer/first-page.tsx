...
export const FirstPage = () => {
  return (
    <div className="h-screen lg:h-screen bg-bgBlue flex items-center flex-col">
      ...
      <div className="w-[70%] h-[25rem] grid md:grid-cols-1 md:pb-20 lg:grid-cols-3 gap-[5rem] ">
        <div
          data-aos="fade-up"
          data-aos-delay="100"
        ...
        >
          ...
          />
          <div className="text-[1.5rem] text-center text-green">
            쉽고 빠른 공동구매 참여
          </div>
        </div>
        <div
